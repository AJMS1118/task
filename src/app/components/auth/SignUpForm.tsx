  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-gray-200 dark:bg-[#1e1e1e] text-gray-900 dark:text-gray-100 transition-colors duration-200 overflow-hidden">
      ...
      <main className="flex-grow flex justify-center items-center py-2">
        <div className="w-full max-w-xs bg-white dark:bg-[#222222] rounded-2xl shadow-lg p-4 border border-gray-200 dark:border-gray-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-1.5 px-4 bg-orange-500 hover:bg-orange-600 text-white font-medium rounded-full text-sm transition-colors duration-200"
            >
              Sign Up
            </button>
          </form>
          ...
          <div className="space-y-2">
            <button
              type="button"
              className="w-full py-1.5 px-4 border border-gray-300 dark:border-gray-700 text-gray-800 dark:text-gray-200 font-medium rounded-full text-xs flex items-center justify-center gap-2 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors duration-200"
            >
