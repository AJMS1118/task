  ...
  return (
    ...
    >
      <span className="flex items-center font-medium text-gray-800 dark:text-gray-200  cursor-pointer">
        ...
        <ChevronDown
          size={14}
          className={`ml-1 text-orange-500 transition-transform ${
      ...
      {isHovered && (
        <div className="absolute mt-3 -left-1 w-48 bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-gray-700 z-10">
